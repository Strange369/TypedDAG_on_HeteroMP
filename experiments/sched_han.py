...
def main(argv):
    ...
    for sparse in range(0, 2):
        ...
        for i in range(5, 65, 5):
            ...
            accept = sched_fed.schedulability_han(data, msets, processor_a, processor_b, mod)
            accept_all.append(accept)
            print('Accepted: ', accept_all)

        results_name = 'outputs/results/results_han_m' + str(msets) + '_a' + str(processor_a) + '_b' + str(processor_b) + '_q' + str(pc_prob) + '_d' + str(mod) + '_r' + str(rho_id) + '_f' + str(mod_1) + '_s' + str(mod_2) + '_m' + str(mod_3) + '_s' + str(sparse)+'.npy'
